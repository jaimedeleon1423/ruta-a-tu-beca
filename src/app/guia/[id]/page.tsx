...
const guias: Record<string, {
  ...
  '2': {
    ...
    secciones: [
      ...
      { titulo: 'Investiga los colegios — no solo los que están cerca', contenido: 'Estudiar en tu comunidad es válido, pero no te limites solo a eso. Hay colegios en la capital y en otras ciudades que ofrecen carreras que quizás no existen cerca de tu casa.\n\nAlgunas opciones para buscar:\n• Colegios del MINEDUC en tu municipio y en la ciudad de Guatemala\n• Institutos técnicos del INTECAP\n• Colegios privados con becas propias\n\nSi el colegio está en la capital, considera: ¿Cuánto tiempo tardarías en llegar? ¿Cuánto costaría el transporte? ¿Es seguro el trayecto? Esos factores también importan al tomar la decisión.' },
      { titulo: 'Para papás y mamás: amplíen las opciones', tipo: 'tip', contenido: 'Estudiar fuera de la comunidad puede ser una gran oportunidad para su hijo/a. Si el colegio ideal está en la ciudad, con la beca cubierta, el gasto principal sería el transporte. Hablen en familia sobre los tiempos de traslado, la seguridad del camino y cómo organizarían el día a día. Una decisión bien pensada puede cambiar el futuro de su familia.' },
    ],
  },
  '3': {
    ...
    secciones: [
      ...
      { titulo: 'Antes de decidir, verifica esto', tipo: 'checklist', contenido: 'Investiga qué colegios ofrecen esa carrera (no solo los cercanos)\\nConfirma que sea plan diario presencial, de lunes a viernes\\nPregunta el costo y si aceptan la beca Vista Hermosa\\nConsidera el tiempo y costo del transporte\\nHabla con alguien que ya esté en esa carrera' },
  ...
  '6': {
    ...
    prevId: 4, nextId: 7,
    secciones: [
      { titulo: 'SEGEPLAN — Secretaría de Planificación', contenido: 'La Secretaría de Planificación y Programación de la Presidencia (SEGEPLAN) administra programas de becas a nivel nacional. Visita su página oficial para consultar convocatorias vigentes: www.segeplan.gob.gt' },
      { titulo: 'MINEDUC — Ministerio de Educación', contenido: 'El Ministerio de Educación ofrece programas de apoyo para estudiantes destacados con necesidad económica. Consulta en la dirección departamental de educación de tu municipio o en su página oficial: www.mineduc.gob.gt' },
  ...
  '12': {
    ...
    secciones: [
      ...
      { titulo: 'Busca prácticas en empresas grandes', contenido: 'Al iniciar sexto año, empieza a investigar empresas donde podrías hacer tus prácticas profesionales. Las prácticas no son solo un requisito escolar — son una oportunidad real de aprender, hacer contactos y, en muchos casos, conseguir tu primer empleo.\\n\\n¿Cómo buscarlas?\\n• Habla con tu director o maestro de área — muchos tienen contactos\\n• Busca empresas de tu rubro en redes sociales o directorios locales\\n• Pregunta a familiares o conocidos que trabajen en empresas grandes\\n• Consulta en cámaras de comercio o asociaciones de tu sector' },
      { titulo: '💡 Reunión de inicio de sexto — Para papás y alumnos', tipo: 'tip', contenido: 'Al comenzar sexto año es ideal hacer una reunión entre alumnos, padres y maestros para hablar sobre las prácticas profesionales: ¿En qué tipo de empresas podrían hacerlas? ¿Quién tiene contactos útiles? ¿Cómo pueden los papás apoyar en la búsqueda? Ese trabajo en equipo puede abrir puertas que cambien el futuro de los estudiantes.' },
